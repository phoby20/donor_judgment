...
function writeTxt(key){
    ...
    //    html += newData[0]['read'];
    html += '</td></tr><tr><th>作成者</th><td>'
    html += newData[0]['author'];
    html += '</td></tr><tr><th>受取人</th><td>'
    html += newData[0]['receiver'];

    html += '</td></tr><tr><th>作成日</th><td>'
    html += newData[0]['year'];
    html += '</td></tr><tr><th>形態</th><td>'
    html += newData[0]['type'];
    html += '</td></tr><tr><th>点数</th><td>'
    html += newData[0]['quantity'];
    html += '</td></tr><tr><th>保存状態</th><td>'
    ...
    html += '</td></tr><tr><th>大分類</th><td>'
    html += newData[0]['class1'];
    html += '</td></tr><tr><th>中分類</th><td>'
