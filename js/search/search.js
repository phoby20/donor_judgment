...
FullTextSearch.prototype = {
    ...
    //refine　絞り込みキーの取り出し
    getParam_refine1 : function (s)    //refine1　絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    getParam_refine2 : function (s)    //refine2　絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    // yearfrom, yearto, hasimage 絞り込みキー取り出し
    // getParam_yearfrom : function (s)    //yearfrom 絞り込みキーの取り出し
    // {
    //     if (!s) return null;
    //     s = s.replace(/\+/g, " ");
    ...
    //     return this.splitKeyword(s);
    // },
    // getParam_yearto : function (s)    //yearto 絞り込みキーの取り出し
    // {
    //     if (!s) return null;
    //     s = s.replace(/\+/g, " ");
    ...
    //     return this.splitKeyword(s);
    // },
    getParam_hasimage : function (s)    //hasimage 絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    // class 絞り込みキー取り出し
    getParam_class1 : function (s)    //class1 絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    getParam_class2 : function (s)    //class2 絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    getParam_class3 : function (s)    //class3 絞り込みキーの取り出し
    {
        if (!s) return null;
        s = s.replace(/\+/g, " ");
    ...
    do_find : function (keyword,refine1,refine2,hasimage,class1,class2,class3)
    {
        ...
        var re = this.find(keyword,refine1,refine2,hasimage,class1,class2,class3);
    ...
    find : function (keyword,refine1,refine2,hasimage,class1,class2,class3)
    {
