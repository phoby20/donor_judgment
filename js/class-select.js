...
const classes =
{
    ...
    "感染症、性病、寄生虫疾患" : {"輸血歴": [], "ＣＪＤ": [], "vＣＪＤ": [], "結核": [], "ＥＢウイルス感染症" : [], "伝染性単核球症" : [], "ＨＩＶ" : [], "梅毒" : [], "性感染症" : [], "海外渡航" : [], "マラリア" : [], "ウエストナイルウイルス" : [], "デング熱" : [], "シャーガス病" : [], "アフリカトリパノソーマ症" : [], "バベシア症" : [], "ＨＴLV－I" : [], "トキソプラズマ感染症" : [], "りんご病等" : [], "ウイルス性皮膚疾患等" : [], "予防接種" : [], "その他" : []},
