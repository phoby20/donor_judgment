...
const classes =
{
    ...
    "呼吸器疾患" : {"呼吸機能": [], "気管支喘息（咳喘息含む）": [], "異常呼吸": [], "自然気胸他" : [], "否定形抗酸菌症（MAC）" : [], "間質性肺炎" : []},
    "循環器疾患" : {"血圧": [], "血栓症": [], "下肢静脈瘤": [], "深部性脈血栓": [], "先天性心疾患" : [], "後天性心疾患" : [], "徐脈" : [], "虚血性心疾患" : [], "心電図所見" : [], "不整脈" : [], "動脈疾患" : [], "心膜疾患" : [], "心筋疾患" : []},
    "消化器疾患" : {"潰瘍性大腸炎、クローン病" : [], "虫垂炎" : [], "その他" : []},
    "肝・胆・膵疾患" : {"ウイルス肝炎（A型肝炎）": [], "ウイルス肝炎（B型肝炎）": [], "ウイルス肝炎（C型肝炎）": [], "ウイルス肝炎（E型肝炎）": [], "ウイルス肝炎": [], "服薬中、疾患検査中、疾患治療中": [], "体質性黄疸": [], "胆石": [], "脾腫" : [], "脾摘出" : [], "慢性肝炎" : [], "脂肪肝" : [], "薬剤性肝障害・アルコール性肝障害" : [], "ＬＤＨ" : [], "肝機能検査その他" : [], "脾腫" : []},
    "代謝・栄養疾患" : {"高度の肥満": [], "脂質異常症": [], "低体重": [], "糖尿病": [], "痛風、高尿酸血症" : []},
    "内分泌疾患" : {"甲状腺疾患": [], "内分泌疾患": []},
    "血液・造血器疾患" : {"血算": [], "生化学": [], "凝固系": [], "造血器疾患": [], "その他" : []},
    "腎・尿路疾患、水電解質異常" : {"急性腎炎": [], "ネフローゼ症候群": [], "慢性腎炎": [], "腎機能": [], "尿検査" : [], "結石" : [], "その他" : []},
    "遺伝性疾患" : {"遺伝性疾患": []},
    "神経・筋疾患" : {"けいれん性疾患": [], "悪性高熱症": [], "脳血管性障害": [], "ギラン・バレー症候群": [], "ＩｇＡ欠損症" : []},
    "感染症、性病、寄生虫疾患" : {"感染症の基本的考え方": [],"輸血歴": [], "ＣＪＤ": [], "vＣＪＤ": [], "結核": [], "ＥＢウイルス感染症" : [], "伝染性単核球症" : [], "ＨＩＶ" : [], "梅毒" : [], "性感染症" : [], "海外渡航" : [], "マラリア" : [], "ウエストナイルウイルス" : [], "デング熱" : [], "シャーガス病" : [], "アフリカトリパノソーマ症" : [], "バベシア症" : [], "ＨＴLV－I" : [], "トキソプラズマ感染症" : [], "りんご病等" : [], "ウイルス性皮膚疾患等" : [], "予防接種" : [], "その他" : []},
    ...
    "皮膚科疾患" : {"乾癬": [], "天疱瘡": [], "血管確保": [], "白斑": [], "その他" : []},
    "眼科" :  {"緑内障": [], "白内障": [], "角膜疾患": [], "眼底疾患": [], "眼底異常": [], "飛蚊症(ひぶんしょう)": [], "眼振": [], "色覚異常": [], "夜盲": [], "その他" : []},
    "歯科疾患" : {"歯列矯正、歯科治療": []},
