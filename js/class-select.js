...
const classes =
{
    ...
    "感染症、性病、寄生虫疾患" : {"感染症の基本的考え方": [],"輸血歴": [], "CJD": [], "vCJD": [], "結核": [], "EBウイルス 感染症" : [], "伝染性単核球症" : [], "HIV" : [], "梅毒" : [], "性感染症" : [], "海外渡航" : [], "マラリア" : [], "ウエストナイルウイルス" : [], "デング熱" : [], "シャーガス病" : [], "アフリカトリパノソーマ症" : [], "バベシア症" : [], "HTLVーI" : [], "トキソプラズマ感染症" : [], "りんご病等" : [], "ウイルス性皮膚疾患等" : [], "予防接種" : [], "その他" : []},
